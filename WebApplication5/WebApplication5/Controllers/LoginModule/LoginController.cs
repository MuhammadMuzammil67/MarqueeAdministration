            ...
            if (ModelState.IsValid)
            {
                if (WebSecurity.UserExists(link.username))
                {
                    ...
                    else
                    {
                        ...
                        mail.From = new MailAddress("Codepub@mehira.marqueeadministration.com");
                        ...
                        smtp.Credentials = new NetworkCredential("Codepub@mehira.marqueeadministration.com", "Akk5444@302");
                        smtp.Send(mail);
